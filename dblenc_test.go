...
var testCases = []TestCase{
    ...
    {
        Name:             "UTF8_Double_Encoded_Truncated_With_Leading_ASCII",
        Original:         "wąwż",
        OriginalHex:      decode("77c48577c5"),
        DoubleEncoded:    "wÄ…wÅ",
        DoubleEncodedHex: decode("77c384e280a677c385"),
    ...
    },
    {
        ...
        DoubleEncoded:    "Tomáš",
        DoubleEncodedHex: decode("546f6dc3a1c5a1"),
...
func TestDetect(t *testing.T) {
    ...
    for _, tc := range testCases {
        t.Run(tc.Name, func(t *testing.T) {
            result, offset := bm.Detect(tc.DoubleEncodedHex)
